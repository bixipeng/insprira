...
import { renderSkills, filterSkills, openSkillDetail, openAgentWithSkill, checkSkillUpdates, updateCommunitySkillsUi, renderAgent, startNewAgentThread, switchAgentThread, clearCurrentAgentThread, deleteAgentThread, renderAgentThreads, onAgentProviderChange, formatTime, copyAgentMessage, deleteAgentMessage, regenerateAgentMessage, handleAgentInputKeydown, renderAgentMessages, showSkillCommands, insertSkillCommand, sendAgentMessage, loadSkills, clearSkillCache, bindSkillToSource, classifySkills } from './pages/agent.js';
...
// Agent 配置
registerAction('openAgentConfigModal', (_, d) => openAgentConfigModal(d.id || ''));
registerAction('submitAgentConfig', (_, d) => submitAgentConfig(d.id || ''));
registerAction('editAgentConfig', (_, d) => editAgentConfig(d.id));
registerAction('toggleAgentConfig', (_, d) => toggleAgentConfig(d.id));
registerAction('deleteAgentConfig', (_, d) => deleteAgentConfig(d.id));
